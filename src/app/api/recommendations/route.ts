...
export async function GET(req: NextRequest) {
  try {
    ...
    try {
      ...
      const prompt = `
        You are an expert AI business analyst for a retail business. 
      ...
      // If we hit a quota error, we silently serve the algorithmic responses 
      // but maybe append a subtle note on one of them so the user isn't totally confused.
